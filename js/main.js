...
const translations = {
    en: {
        ...
        "hero.map_badge": "US Rails / Global Settlement",
        ...
        "contact.page.title": "Connect with our <br><span class=\"text-primary\">OTC</span> team",
        "contact.page.desc": "We offer high-volume operations in USD, COP, MXN and EUR, with personalized attention, secure execution and full confidentiality.",
        "contact.page.f1": "Confidentiality & Security",
        "contact.page.f2": "Personalized attention",
        "contact.page.f3": "Fast response",
        "contact.page.quick": "Prefer a quick option:",
        "contact.page.wa.title": "Chat on WhatsApp",
        "contact.page.wa.desc": "Immediate responses for quick inquiries.",
        "contact.page.wa.btn": "Start chat ➔",
        "contact.page.meet.title": "Direct Meeting",
        "contact.page.meet.desc": "Schedule a meeting with our OTC team.",
        "contact.page.meet.btn": "Schedule meeting ➔",
        "contact.page.secure": "<strong class=\"text-gray-800 dark:text-gray-200 font-semibold\">Your information is protected.</strong> We comply with the highest security standards.",
        ...
        "kyc.s1.name.natural": "Full Name *",
        "kyc.s1.name.juridica": "Company Name *",
        "kyc.s1.id": "Tax ID / National ID *",
        "kyc.s1.id.natural": "ID Document (Passport / ID) *",
        "kyc.s1.id.juridica": "Tax ID (NIT) *",
        "kyc.s1.city": "City *",
    ...
    es: {
        ...
        "hero.map_badge": "US Rails / Liquidación Global",
        ...
        "success.desc": "Un ejecutivo te contactará pronto por correo o WhatsApp.",

        // Contact Page
        "contact.page.badge": "CONTACTO",
        "contact.page.title": "Conecta con nuestro equipo<br><span class=\"text-primary\">OTC</span>",
        "contact.page.desc": "Ofrecemos operaciones de alto volumen en USD, COP, MXN y EUR, con atención personalizada, ejecución segura y total confidencialidad.",
        "contact.page.f1": "Confidencialidad y seguridad",
        "contact.page.f2": "Atención personalizada",
        "contact.page.f3": "Respuesta rápida",
        "contact.page.quick": "Prefiere una opción rápida:",
        "contact.page.wa.title": "Chat por WhatsApp",
        "contact.page.wa.desc": "Respuestas inmediatas para consultas rápidas.",
        "contact.page.wa.btn": "Iniciar chat ➔",
        "contact.page.meet.title": "Reunión directa",
        "contact.page.meet.desc": "Agenda una reunión con nuestro equipo OTC.",
        "contact.page.meet.btn": "Agendar reunión ➔",
        "contact.page.secure": "<strong class=\"text-gray-800 dark:text-gray-200 font-semibold\">Tu información está protegida.</strong> Cumplimos con los más altos estándares de seguridad.",
        ...
        "kyc.s1.name.natural": "Nombre Completo *",
        "kyc.s1.name.juridica": "Razón Social *",
        "kyc.s1.id": "NIT / CC *",
        "kyc.s1.id.natural": "Documento de Identidad (CC / Pasaporte) *",
        "kyc.s1.id.juridica": "NIT *",
        "kyc.s1.city": "Ciudad *",
        "kyc.s1.country": "País *",
